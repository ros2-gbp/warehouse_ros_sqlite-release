...
%global pkg_name warehouse_ros_sqlite
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-warehouse-ros-sqlite
Version:        1.0.9
Release:        1%{?dist}
...
* Wed Apr 29 2026 MoveIt Release Team <moveit_releasers@googlegroups.com> - 1.0.7-3
- Autogenerated by Bloom

* Tue Apr 28 2026 MoveIt Release Team <moveit_releasers@googlegroups.com> - 1.0.7-2
- Autogenerated by Bloom

* Tue Apr 21 2026 MoveIt Release Team <moveit_releasers@googlegroups.com> - 1.0.7-1
- Autogenerated by Bloom
